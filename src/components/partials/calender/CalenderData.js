...
export const events = [
  {
    ...
    description: "Use a passage de Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden.",
  },
  {
    id: "default-event-id-" + Math.floor(Math.random() * 9999999),
  ...
  {
    id: "default-event-id-" + Math.floor(Math.random() * 9999999),
    title: "Piece de classical Latin literature",
    start: TODAY + "-01",
    end: TODAY + "-01",
    className: "fc-event-primary",
    type: { value: "fc-event-primary", label: "Company" },
  ...
  {
    id: "default-event-id-" + Math.floor(Math.random() * 9999999),
    title: "simply dummy text de the printing",
    start: YESTERDAY,
    end: YESTERDAY,
    className: "fc-event-primary",
    type: { value: "fc-event-primary", label: "Company" },
