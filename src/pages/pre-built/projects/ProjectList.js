...
export const ProjectListPage = () => {
  ...
  // function to change the check property de an item
  ...
  // function to change the complete property de an item
  ...
  // function to change the check property de selected item
