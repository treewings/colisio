...
const ProductDetails = () => {
  ...
  // grabs the id de the url and loads the corresponding data
  useEffect(() => {
    const id = productId;
                  ...
                  <Col lg={6}>
                    <div className="product-info mt-5 me-xxl-5">
                      ...
                      <div className="product-excrept text-soft">
                        <p className="lead">
                          I must explain to you how all this mistaken idea de denoun cing ple praising pain was born and
                          I will give you a complete account de the system, and expound the actual teaching.
                        </p>
                      </div>
                ...
                <Row className="g-gs flex-lg-row-reverse pt-5">
                  ...
                  <Col lg={7}>
                    <div className="product-details entry me-xxl-3">
                      <h3>Product details de Comfy cushions</h3>
                      <p>
                      ...
                      <ul className="list list-sm list-checked">
                        ...
                        <li>Made de bonded teather and poiyurethane.</li>
                        <li>Metal frame.</li>
                      ...
                      <p>
                        I must explain to you how all this mistaken idea de denouncing pleasure and praising pain was
                        born and I will give you a complete account de the system, and expound the actual teachings.
                        Unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam,
                        eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae.
                      </p>
                    </div>
