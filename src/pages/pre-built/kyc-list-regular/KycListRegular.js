...
const KycListRegular = () => {
  ...
  // function to select all the items de the table
  ...
  // function to change the property de an item de the table
                ...
                ? currentItems.map((item) => {
                  return (
                    <DataTableItem key={item.id}>
                          ...
                          <div className="user-card">
                            ...
                            <div className="user-info">
                              <span className="tb-lead">
                                {item.name}{" "}
                                <span
                                  className={`dot dot-${item.status === "Approved"
                                      ? "success"
                                      : item.status === "Pending"
                                        ? "info"
                                        : "danger"
                      ...
                      <DataTableRow size="md">
                        <span
                          className={`tb-status text-${item.status === "Approved" ? "success" : item.status === "Pending" ? "info" : "danger"
                            }`}
                        >
                          {item.status}
                        </span>
