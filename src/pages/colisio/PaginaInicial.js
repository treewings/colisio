...
// importa uma imagem que esta na pasta public
// import img from "../../../public/colisio_fundo.png";
      ...
      <Content page="">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            // usa a img importada como fundo
            ...
            <BlockDes>
              <p className="lead mb-3">
                Concentre-se em sua estratégia e colabore com especialistas
                selecionados a dedo para impulsionar seu negócio.
              </p>
            </BlockDes>
            <BlockDes>
              <button class="btn-round btn btn-primary btn-lg">Comece agora</button>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
            ...
            <Row className="gy-4">
              ...
              <Col xl="12">
                <p className="text-soft">
                  For large or small size de <code>.custom-checkbox</code>, use <code>.custom-control-{`lg|sm`}</code>{" "}
        ...
        <Block size="lg">
          ...
          <PreviewCard>
            <Row className="gy-4">
              ...
              <Col xl="12">
                <p className="text-soft">
                  For large or small size de <code>.custom-radio</code>, use <code>.custom-control-{`lg|sm`}</code> with{" "}
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                The switch markup de a <code>.custom-control</code> <code className="code-fnc">checkbox</code> but uses
          ...
          <PreviewCard>
            <Row className="gy-4">
              ...
              <Col xl="12">
                <p className="text-soft">
                  For large or small size de <code>.custom-switch</code>, use <code>.custom-control-{`lg|sm`}</code>{" "}
                  with <code>.custom-control</code> className.
                </p>
              </Col>
            </Row>
