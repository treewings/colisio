      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">Documentation and Example de User Avatar</p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Add any de the below props to the <code>UserAvatar</code> components to change the appearance de a
                avatar.
              </p>
            </BlockHeadContent>
          </BlockHead>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Add any de the below colors to <code>theme</code> props to the <code>UserAvatar</code> component to
                change the appearence de a avatar.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Add any de the below sizes to <code>className</code> props to the <code>UserAvatar</code> component to
                change the appearence de a avatar.
              </p>
            </BlockHeadContent>
          </BlockHead>
