                ...
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
                      ...
                      <p>With the button group make a series de buttons together.</p>
                    </div>
                    <div className="g">
                      <span className="btn btn-icon btn-trigger me-n1">
                        <Icon name="chevron-right"></Icon>
                ...
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
                      ...
                      <p>Examples de types de dropdowns and styles</p>
                    </div>
                    <div className="g">
                      <span className="btn btn-icon btn-trigger me-n1">
                        <Icon name="chevron-right"></Icon>
                ...
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
                      ...
                      <p>Examples de modal or lightbox style for any content.</p>
                    </div>
                    <div className="g">
                      <span className="btn btn-icon btn-trigger me-n1">
                        <Icon name="chevron-right"></Icon>
                ...
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
                      ...
                      <p>Examples de pagination to indicate a multiple pages.</p>
                    </div>
                    <div className="g">
                      <span className="btn btn-icon btn-trigger me-n1">
                        <Icon name="chevron-right"></Icon>
                ...
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
                      ...
                      <p>Example de loading state de a component or pages.</p>
                    </div>
                    <div className="g">
                      <span className="btn btn-icon btn-trigger me-n1">
                        <Icon name="chevron-right"></Icon>
                ...
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
                      ...
                      <p>Example de tabbed interface navigation components.</p>
                    </div>
                    <div className="g">
                      <span className="btn btn-icon btn-trigger me-n1">
                        <Icon name="chevron-right"></Icon>
                ...
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
                      ...
                      <p>Examples de push notifications using bootstrap toast.</p>
                    </div>
                    <div className="g">
                      <span className="btn btn-icon btn-trigger me-n1">
                        <Icon name="chevron-right"></Icon>
                ...
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
                      ...
                      <p>Examples for opt-in styling de tables with variants.</p>
                    </div>
                    <div className="g">
                      <span className="btn btn-icon btn-trigger me-n1">
                        <Icon name="chevron-right"></Icon>
                ...
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
                      ...
                      <p>Example de well optimized and custom design table.</p>
                    </div>
                    <div className="g">
                      <span className="btn btn-icon btn-trigger me-n1">
                        <Icon name="chevron-right"></Icon>
                ...
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
                      ...
                      <p>Basic example de form control with size variants.</p>
                    </div>
                    <div className="g">
                      <span className="btn btn-icon btn-trigger me-n1">
                        <Icon name="chevron-right"></Icon>
                ...
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
                      ...
                      <p>Example de layout for creating variety de forms.</p>
                    </div>
                    <div className="g">
                      <span className="btn btn-icon btn-trigger me-n1">
                        <Icon name="chevron-right"></Icon>
                ...
                <div className="card-inner">
                  <div className="align-center justify-between">
                    <div className="g">
                      ...
                      <p>Example de form validation using validate plugin.</p>
                    </div>
                    <div className="g">
                      <span className="btn btn-icon btn-trigger me-n1">
                        <Icon name="chevron-right"></Icon>
