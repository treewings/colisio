      ...
      <Content page="component">
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>Add any de the below mentioned modifier props to change the appearance de a badge.</p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h5">Example with Variations</BlockTitle>
              <p>Add any de the below mentioned modifier classNames to change the appearance de a badge.</p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
            <OverlineTitle tag="span" className="preview-title">
