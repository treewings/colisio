...
export const pricingTableDataV1 = [
  {
    id: "plan-iv-1",
    title: "Starter",
    caption: "Enjoy entry level de invest & earn.",
    interest: 1.67,
    term: 30,
  ...
  },
  {
    id: "plan-iv-3",
    title: "Diamond",
    caption: "Advance level de invest & earn.",
    interest: 14.29,
    term: 14,
    startDate: "Nov 04, 2019",
    endDate: "Nov 18, 2019",
...
export const cardPreview = [
  {
    ...
    desc: "Some quick example text to build on the card title and make up the bulk de the card's content.",
  },
  {
    id: 1,
    img: StockB,
