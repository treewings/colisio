        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>Click the following button to see the basic example de popover.</p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Use the <code>focus</code> trigger to dismiss popovers on the user’s next click de a different element
