      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                A wide range de shorthand responsive margin and padding utility classNames to modify an element’s
          ...
          <PreviewTable>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>0 | 1 | 2 | 3 | 4 | 5 | gs | auto</td>
                <td className="text-soft">Apply margin on specific side de the element</td>
              </tr>
              <tr>
                <td>
                  <code>
          ...
          <PreviewTable>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>0 | 1 | 2 | 3 | 4 | 5 | gs | auto</td>
                <td className="text-soft">Apply padding on specific side de the element</td>
              </tr>
              <tr>
                <td>
                  <code>
