...
const CardsPage = ({ ...props }) => {
              ...
              <Col lg="4">
                <Card className="card-bordered">
                  ...
                  <CardBody className="card-inner">
                    ...
                    <CardText>
                      Some quick example text to build on the card title and make up the bulk de the card"s content.
                    </CardText>
  ...
  <CardBody className="card-inner">
    ...
    <CardText>
      ...
      the bulk de the card's content.
    </CardText>
    <Button color="primary">Go somewhere</Button>
  </CardBody>
</Card>`}
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Use <a href="/utlities/color">colors utilities</a> to change the appearance de a card.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
  ...
  <CardBody className="card-inner">              
    ...
    <CardText>
      ...
      up the bulk de the card's content.
    </CardText>
  </CardBody>
</Card>`}
          </CodeBlock>
