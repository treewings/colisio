      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                A slideshow component for cycling through elements or slides de text—like a carousel. To use it{" "}
                <code>
                  Import
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Add <code>.carousel-fade</code> to your carousel to animate slides with a fade transition instead de a
                slide.
              </p>
            </BlockHeadContent>
          </BlockHead>
