      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                Provide contextual feedback messages for typical user actions with the handful de available and flexible
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Alerts are available for any length de text. Use <code> {`Alert`}</code> component with{" "}
