          ...
          <BlockHeadContent>
            ...
            <BlockDes>
              ...
              <p>
                ...
                the Component.js file de the component directory. Such as{" "}
                <code>import {`{Icon}`} from "./components/Component"</code> use the name props de the Icon to show the
                specific icon.
                <br />
                Example de uses - <code className="code-tag">{`<Icon name="icon-name"/>`}</code>
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
