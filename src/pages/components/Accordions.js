      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                Toggle the visibility de content across your project with a few classes and Bootstrap collapse
    ...
    return (
      <div className="accordion">
        ...
        <div className="accordion-item">
          ...
          >
            <h6 className="title">
              What are some de the benefits de receiving my bill electronically?
            </h6>
            <span className="accordion-icon"></span>
          </div>
          <Collapse
        ...
        <div className="accordion-item">
          <div
            ...
            onClick={() => setIsOpen("4")}
          >
            <h6 className="title">What are the benefits de using Dashlite?</h6>
            <span className="accordion-icon"></span>
          </div>
          <Collapse
            className="accordion-body"
