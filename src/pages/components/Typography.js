          ...
          <PreviewTable>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <p>
                    <del>This line de text is meant to be treated as deleted text.</del>
                  </p>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <p>
                    <s>This line de text is meant to be treated as no longer accurate.</s>
                  </p>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <p>
                    <ins>This line de text is meant to be treated as an addition to the document.</ins>
                  </p>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <p>
                    <u>This line de text will render as underlined</u>
                  </p>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <p>
                    <small>This line de text is meant to be treated as fine print.</small>
                  </p>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <p className="lead">This line de text is meant to lead text to stand out.</p>
                </td>
              </tr>
            </tbody>
          </PreviewTable>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                For quoting blocks de content from another source within your document. Use .blockquote in{" "}
                {`<blockquote>`}.
              </p>
            </BlockHeadContent>
          </BlockHead>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                de two classes, <code>.list-inline</code> and <code>.list-inline-item</code>.
              </p>
            </BlockHeadContent>
          </BlockHead>
