      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                Form is most esential part de your project. We styled out nicely so you can build your form so quickly.
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
              ...
              <Row className="g-3 align-center">
                <Col lg="5">
                  <div className="form-group">
                    ...
                    <span className="form-note">Specify the name de your website.</span>
                  </div>
                </Col>
                <Col lg="7">
                  <div className="form-group">
              ...
              <Row className="g-3 align-center">
                <Col lg="5">
                  <div className="form-group">
                    ...
                    <span className="form-note">Specify the email address de your website.</span>
                  </div>
                </Col>
                <Col lg="7">
                  <div className="form-group">
              ...
              <Row className="g-3 align-center">
                <Col lg="5">
                  <div className="form-group">
                    ...
                    <span className="form-note">Copyright information de your website.</span>
                  </div>
                </Col>
                <Col lg="7">
                  <div className="form-group">
