          ...
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                ...
                groups on either side de text inputs, custom selects, and custom file inputs.
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Place one add-on or button on either side de an input. You may also place one on both sides de an input.
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>Place any checkbox or radio option within an input group’s addon instead de text.</p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
            <Row className="g-4">
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>
                  Input groups include support for custom file inputs. Browser default versions de these are not
                  supported.
                </p>
              </BlockDes>
            </BlockHeadContent>
