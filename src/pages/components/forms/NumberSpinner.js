          ...
          <PreviewTable>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  Use <code>{`{color}`}</code> with <code>color</code> props to specify the color de the button.
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  Use <code>{`{number}`}</code> with <code>defaultVal</code> props to specify any default value de the
                  input.
                </td>
              </tr>
            </tbody>
