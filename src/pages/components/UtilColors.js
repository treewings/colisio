      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                Convey meaning through color with a handful de color utility classNames. This utilities to quickly style
                the text and background de any element.
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                A set de solid background utilities classNames. Use <code className="code-class">.bg-[color]</code>{" "}
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                A set de shade color de gray and dark classNames. Use{" "}
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                A set de text color utilities className. Use <code className="code-class">.text-{"{theme|color}"}</code>{" "}
