      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                Indicate the loading state de a component or page with Bootstrap spinners. To use it, import it such as{" "}
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                color utilities. You can use any de our text color utilities on the standard spinner.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                swap the text out de the spinner element and utilize button text as needed.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
