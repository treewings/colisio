...
const FlexPage = ({ ...props }) => {
      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                Quickly manage the layout, alignment, and sizing de grid columns, navigation, components, and more with
                a full suite de responsive flexbox utilities.
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Default horizontal direction de flex item is <code className="highlighter-rouge">row</code>. If you want
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                the alignment de flex items. There are many classNames. just add{" "}
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                alignment de flex items on the cross axis. There are many classNames. just add{" "}
        ...
        <Block size="lg">
          ...
          <PreviewCard>
            <div className="d-flex bg-light">
              <div className="p-2 flex-fill bg-light">Flex item with a lot de content</div>
  ...
  <div className="flex-fill">
    Flex item with a lot de content
  </div>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Change the visual order de specific flex items with a handful of{" "}
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                we’ve enforced <code>flex-wrap: wrap</code> and increased the number de flex items.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
