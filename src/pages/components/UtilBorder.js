      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">Use border utilities to quickly style the border and border-radius de an element.</p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>You can add border to any side de an element with border utilities classes.</p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
          ...
          <PreviewTable>
            ...
            <tbody>
              <tr>
                ...
                <td>Add border in all sides de an element </td>
              </tr>
              <tr>
                <td>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>You can remove border to a single side de an element with below border utilities classes.</p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
          ...
          <PreviewTable>
            ...
            <tbody>
              <tr>
                ...
                <td>Remove border from all sides de an element</td>
              </tr>
              <tr>
                <td>
                  <code>.border-{"{top|bottom|start|end}"}-0</code>
                </td>
                <td>Remove border from specific side de an element</td>
              </tr>
            </tbody>
          </PreviewTable>
          ...
          <PreviewTable>
            ...
            <tbody>
              <tr>
                ...
                <td>Apply rounded corner de an element</td>
              </tr>
              <tr>
                <td>
                  <code>.rounded-{"{top|bottom|start|end}"}</code>
                </td>
                <td>Apply rounded on specific corner de an element</td>
              </tr>
              <tr>
                <td>
                  <code>.rounded-circle</code>
                </td>
                <td>Apply full circle box de an element</td>
              </tr>
              <tr>
                <td>
                  <code>.rounded-pill</code>
                </td>
                <td>Apply pill rounded corner de an element</td>
              </tr>
              <tr>
                <td>
                  <code>.rounded-0</code>
              ...
              <tr>
                ...
                <td>Apply small and large rounded corner de an element</td>
              </tr>
            </tbody>
          </PreviewTable>
