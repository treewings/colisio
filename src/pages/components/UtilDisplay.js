      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                Quickly and responsively toggle the display value de components and more with our display utilities.
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>These utilities classNames allow to set display property de an element.</p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewTable>
