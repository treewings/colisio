        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>A bar chart provides a way de showing data values represented as vertical bars.</p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
            <Row>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>A bar chart provides a way de comparison de multiple data sets side by side.</p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
            <Row>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>A bar chart provides a way de comparison de multiple data with stacked view.</p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
            <Row>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>A line chart is a way de plotting data points on a line.</p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
            <Row>
    ...
    <React.Fragment>
      <div className="card-title-group align-start gx-3 mb-3">
        <div className="card-title">
          ...
          <p>
            In 30 days sales de product subscription.{" "}
            <a
              href="#details"
              onClick={(ev) => {
                ev.preventDefault();
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                A line chart is a way de plotting data points on a line. Often, it is used to show trend data, or the
                comparison de two data sets.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
