      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                Examples for showing pagination to indicate a series de related content exists across multiple pages.To
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>The following example de basic pagination. Use pagination component from reactstrap</p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Looking to use an icon or symbol in place de text for some pagination links? Be sure to provide proper
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Change the alignment de pagination components with flexbox utilities as use
