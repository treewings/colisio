        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>
                  Full Knobs can be made using the built in react dashlite component de <code>Knob</code>.
                </p>
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>
                  Half Knobs can be made using the built in react dashlite component de <code>Knob</code>. Just pass{" "}
