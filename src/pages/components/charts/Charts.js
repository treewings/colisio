          ...
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                ...
                designers & developers. You can visualize your data in different ways. We present some de examples for
                you.
              </p>
              <p>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>A bar chart provides a way de comparison de multiple data sets side by side or with stacked view.</p>
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
          <Row className="g-gs">
