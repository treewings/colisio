...
export const inboxList = [
      ...
      reply: [
        {
          ...
          replyMessage: [
            "Hello team",
            "I am facing problem with the creation de a new page. Can you guys let me know what i am doing doing wrong? Please check attached files.",
            "Thank you",
          ],
        },
        {
      ...
      reply: [
        {
          ...
          replyMessage: [
            "Hello team",
            "Can you clear out some de the policies, I am facing difficulties understanding them.",
            "Thank you",
          ],
        },
        {
  ...
  },
  {
    ...
    userId: 2,
    message: {
      subject: "Thank you for completion de survey",
      meta: {
        tags: [],
        inbox: true,
        unread: false,
      ...
      reply: [
        {
          ...
          date: "14 Jan, 2020",
          time: "09:30 AM",
          replyMessage: ["Hi there", "Just wanted to show our gratitude you for completion de the survey", "Thank you"],
        },
        {
          replyId: "rep_2",
          userId: 3,
...
export const contacts = [
  ...
  },
  {
    ...
    img: User3,
    theme: "primary",
    designation: "Co-Founder de Vitzo",
