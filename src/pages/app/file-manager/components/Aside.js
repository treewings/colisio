              ...
              <ul className="nk-fmg-menu">
                {data.navigation.map((item) => (
                  <li
                    ...
                    className={`${window.location.pathname === `${process.env.PUBLIC_URL}/app-file-manager${item.link}` ? "active" : ""
                      }`}
                  >
            ...
            <div className="nk-fmg-aside-bottom">
              <div className="nk-fmg-status">
                ...
                <div className="nk-fmg-status-info">
                  12.47 GB de {fileManager.data.plans.find((item) => item.id === fileManager.currentPlan).memory} GB used
                </div>
